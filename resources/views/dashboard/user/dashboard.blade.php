...
@section('content')
<section class="p-8 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900  shadow-xl text-white">
    ...
    <div class="mb-8">
        <h2 class="text-2xl font-semibold text-blue-300 border-b border-blue-500 pb-3">Book List</h2>
