...
@section('content')
<section class="p-10 min-h-screen bg-black/80 text-white flex justify-center items-center">
    <div class="max-w-6xl w-full">
        ...
        <div class="flex flex-col lg:flex-row justify-between items-center mb-8">
            ...
            <a href="{{ route('book.create') }}" 
                class="mt-4 lg:mt-0 px-6 py-3 bg-gray-600 text-white font-semibold rounded-lg shadow-md hover:bg-gray-500 transition transform hover:scale-105">
                 Add Book
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            @forelse ($books as $book)
                <div class="bg-gray-600 bg-opacity-50 backdrop-blur-md p-4 rounded-xl shadow-lg hover:scale-105 transition">
        ...
        <div class="flex justify-between items-center mt-8 text-gray-400">
            ...
            <div class="flex gap-2">
                ...
                @for ($i = 1; $i <= $books->lastPage(); $i++)
                    <a href="{{ $books->url($i) }}" class="px-4 py-2 {{ $books->currentPage() == $i ? 'bg-gray-600 text-white' : 'bg-gray-700 hover:bg-gray-600' }} rounded">
                        {{ $i }}
                    </a>
                @endfor
